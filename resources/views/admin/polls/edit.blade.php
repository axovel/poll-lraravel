                        ...
                        <div class="panel-body">
                            <form class="form-horizontal " role="form" method="POST" name="addPoll" action="{{ route('admin.poll.update',['id' => $poll->id]) }}">
                                ...
                                <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="title" type="text" class="form-control" name="title" value="{{ $poll->title }}" required>
                                ...
                                <div class="form-group{{ $errors->has('is_display_on_channel') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="is_private_no" type="radio" class="" name="is_private" value="0" <?php if($poll->is_private==0) echo 'checked';?>><label for="is_private_no">No</label>
                                        <input id="is_private_yes" type="radio" class="" name="is_private" value="1" <?php if($poll->is_private==1) echo 'checked';?>><label for="is_private_yes">Yes</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="no" type="radio" class="" name="is_banner" value="0" <?php if($poll->image=='') echo 'checked';?>><label for="no">No</label>
                                        <input id="yes" type="radio" class="" name="is_banner" value="1" <?php if($poll->image!='') echo 'checked';?>><label for="yes">Yes</label>
                                    </div>

                                    <div class="col-md-6 col-md-offset-4 <?php if($poll->image=='') echo 'hidden'?>" id="ad_banner">
                                ...
                                <div class="form-group{{ $errors->has('is_multiselect') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="no-multichoice" type="radio" class="" name="is_multichoice" value="0" <?php if($poll->is_multichoice==0) echo 'checked';?>><label for="no-multichoice">No</label>
                                        <input id="yes-multichoice" type="radio" class="" name="is_multichoice" value="1" <?php if($poll->is_multichoice==1) echo 'checked';?>><label for="yes-multichoice">Yes</label>
                                    </div>
                                </div>
