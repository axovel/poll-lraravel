                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.user.store') }}">
                            ...
                            <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="male" type="radio" class="" name="gender" value="M" checked><label for="male"> Male</label>
                                    <input id="female" type="radio" class="" name="gender" value="F"><label for="female">Female</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('born') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input data-provide="datepicker" name="born" class="form-control datepicker">
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea rows="10" cols="50" name="address" value="{{old('address')}}" class="form-control"></textarea>
                                </div>
                            </div>
